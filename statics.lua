...
haste_triggers = T{
  ['Magic'] = {
    ...
    [421] = {triggering_action='Battlefield Elegy', triggering_id=421, buff_name='Elegy', buff_id=194, haste_category='debuff', trigger_category='Magic', trigger_sub_category='BardSong', persists_thru_zoning=false, potency_base=256}, -- Assume enemies have base potency
    [422] = {triggering_action='Carnage Elegy', triggering_id=422, buff_name='Elegy', buff_id=194, haste_category='debuff', trigger_category='Magic', trigger_sub_category='BardSong', persists_thru_zoning=false, potency_base=512}, -- Assume enemies have base potency
    ...
    [795] = {triggering_action='Indi-Slow', triggering_id=795, buff_name='Slow', buff_id=565, haste_category='debuff', trigger_category='Magic', trigger_sub_category='Geomancy', persists_thru_zoning=false, potency_base=152}, -- Assume enemies have base potency
    [825] = {triggering_action='Geo-Slow', triggering_id=825, buff_name='Slow', buff_id=565, haste_category='debuff', trigger_category='Magic', trigger_sub_category='Geomancy', persists_thru_zoning=false, potency_base=152}, -- Assume enemies have base potency
  },
  ['Job Ability'] = {
