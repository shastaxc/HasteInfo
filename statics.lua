...
haste_triggers = T{
  ['Magic'] = {
    ...
    [421] = {triggering_action='Battlefield Elegy', triggering_id=421, buff_name='Elegy', buff_id=194, haste_category='debuff', trigger_category='Magic', trigger_sub_category='BardSong', persists_thru_zoning=false, potency_base=256, multipliers=T{}}, -- Assume enemies have base potency
    [422] = {triggering_action='Carnage Elegy', triggering_id=422, buff_name='Elegy', buff_id=194, haste_category='debuff', trigger_category='Magic', trigger_sub_category='BardSong', persists_thru_zoning=false, potency_base=512, multipliers=T{}}, -- Assume enemies have base potency
    [ 56] = {triggering_action='Slow', triggering_id=56, buff_name='Slow', buff_id=13, haste_category='debuff', trigger_category='Magic', trigger_sub_category='WhiteMagic', persists_thru_zoning=false, potency_base=300}, -- Assume enemies have base potency
    [ 79] = {triggering_action='Slow II', triggering_id=56, buff_name='Slow', buff_id=13, haste_category='debuff', trigger_category='Magic', trigger_sub_category='WhiteMagic', persists_thru_zoning=false, potency_base=359}, -- Assume enemies have base potency
    [795] = {triggering_action='Indi-Slow', triggering_id=795, buff_name='Slow', buff_id=565, haste_category='debuff', trigger_category='Magic', trigger_sub_category='Geomancy', persists_thru_zoning=false, potency_base=152, multipliers=T{}}, -- Assume enemies have base potency
    [825] = {triggering_action='Geo-Slow', triggering_id=825, buff_name='Slow', buff_id=565, haste_category='debuff', trigger_category='Magic', trigger_sub_category='Geomancy', persists_thru_zoning=false, potency_base=152, multipliers=T{}}, -- Assume enemies have base potency
  },
  ['Job Ability'] = {
  ...
  ['Other'] = {
    ...
    [  2] = {triggering_action='Unknown GEO Haste', triggering_id=0, buff_name='Haste', buff_id=580, haste_category='ma', trigger_category='Magic', trigger_sub_category='Geomancy', persists_thru_zoning=false, potency_base=307, potency=427, multipliers=T{}},
    ...
    [  4] = {triggering_action='Unknown Elegy', triggering_id=0, buff_name='Elegy', buff_id=194, haste_category='debuff', trigger_category='Magic', trigger_sub_category='BardSong', persists_thru_zoning=false, potency_base=512, potency=512, multipliers=T{}}, -- Assume enemies have base potency
    [  5] = {triggering_action='Unknown GEO Slow', triggering_id=0, buff_name='Slow', buff_id=565, haste_category='debuff', trigger_category='Magic', trigger_sub_category='Geomancy', persists_thru_zoning=false, potency_base=152, potency=152, multipliers=T{}}, -- Assume enemies have base potency
  }
}
...
ENTRUST_BUFF_ID = 684
OTHER_RELEVANT_BUFFS = S{52, 231, 513, 569, 612, 684}
...
RESIST_MESSAGE_IDS = S{85,284,653,654}
